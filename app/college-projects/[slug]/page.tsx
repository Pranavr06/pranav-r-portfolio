...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: `${project.title} | Pranav R`,
      description: project.excerpt || project.description || `Read about ${project.title} by Pranav R.`,
      url: `https://pranavr.netlify.app/college-projects/${slug}`,
    ...
    alternates: {
      canonical: `https://pranavr.netlify.app/college-projects/${slug}`,
    }
  };
}
...
export default async function ProjectDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const jsonLd = {
    ...
    "name": project.title,
    "description": project.excerpt || project.description || `A college project by Pranav R titled ${project.title}.`,
    "applicationCategory": "EducationalApplication",
    "operatingSystem": "Desktop",
    "url": `https://pranavr.netlify.app/college-projects/${project.slug}`,
  ...
  return (
    <main>
      <Script
        id={`college-project-schema-${project.slug}`}
