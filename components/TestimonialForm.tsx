  ...
  return (
    <div id="testimonial-form" className="two-column-layout animate-slide-up">
      ...
      <div className="right-form-panel">
        {!user && !isAdminMode ? (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", minHeight: "300px", padding: "2rem", border: "1px dashed rgba(0,0,0,0.1)", borderRadius: "1rem", textAlign: "center" }}>
            <h3 style={{ marginBottom: "1.5rem", fontSize: "1.25rem", fontWeight: "bold" }}>Join to Leave a Testimonial</h3>
            <div className="auth-cta-card" style={{ width: "100%", maxWidth: "400px", margin: "0 auto", border: "none", boxShadow: "none", background: "transparent" }}>
               ...
               <button onClick={handleLogin} className="btn btn-color-2" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", padding: "1rem", width: "100%", fontSize: "1.05rem" }}>
