  ...
  return (
    <div id="testimonial-form" className="two-column-layout animate-slide-up">
        ...
        <div style={{ marginTop: "auto", paddingTop: "2rem" }}>
          ...
          {!user ? (
             <div className="auth-cta-card">
               ...
               <button onClick={handleLogin} className="btn btn-color-2" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", padding: "0.8rem", width: "100%" }}>
      ...
      <div className="right-form-panel">
        {!user && !isAdminMode ? (
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100%", minHeight: "300px", opacity: 0.5, fontStyle: "italic", border: "1px dashed rgba(0,0,0,0.1)", borderRadius: "1rem" }}>
