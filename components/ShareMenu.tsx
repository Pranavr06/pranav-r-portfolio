...
export default function ShareMenu({ title, slug, type = "projects", urlOverride, downloadUrl, downloadName }: { title: string, slug?: string, type?: "projects" | "blogs" | "certificates" | "page" | "college-projects", urlOverride?: string, downloadUrl?: string, downloadName?: string }) {
  ...
  const getTypeName = () => {
    ...
    if (type === "college-projects") return "College Project";
